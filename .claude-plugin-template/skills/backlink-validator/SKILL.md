...
- Location: `/Users/jheckman/k1-kiosk/Builds/Proto/Weekly Reports/`
- Check for links to:
...
`/Users/jheckman/k1-kiosk/Backlink-Validation-Report-YYYY-MM-DD.md`
...
User: "Validate K1 backlinks"

Your response:
1. Scan all markdown files in `/Users/jheckman/k1-kiosk/`
