...
# Vault path
sed -i '' 's/k1-kiosk/your-vault-name/g' CLAUDE.md
...
mv k1-automation yourprogram-automation
...
2. **File paths**: Replace `/Users/jheckman/k1-kiosk/` with your vault path
...
sed -i '' 's/k1-kiosk/phoenix-tracker/g' CLAUDE.md
sed -i '' 's/k1:/phoenix:/g' CLAUDE.md

# Update plugin
mv ~/.claude/plugins/local/k1-automation ~/.claude/plugins/local/phoenix-automation
